                ...
                <div class="banner-text">
                    ...
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item">
                        ...
                        <li class="breadcrumb-item"><a href="our-sarvice.html">Our Service</a></li>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6">
        <div class="dog-walker two d-block">
          <img src="assets/img/dog-walker-2.png" alt="dog walker">
      ...
      <div class="row align-items-center my-4">
        ...
        <div class="col-lg-7">
          <div class="video position-relative">
                        ...
                        <img src="assets/img/service-video.jpg" alt="img">
                    </div>
        </div>
      </div>
