            ...
            <div class="card-body">
                <ul class="list-unstyled">
                    <li class="mb-2">
                        ...
                        Category name will be used to generate URL slug automatically
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-sort text-warning me-2"></i>
                        Sort order determines the display order on frontend
                    </li>
                    <li class="mb-2">
                    ...
                    <li class="mb-2">
                        ...
                        Only active categories will be visible on frontend
                    </li>
                </ul>
            </div>
        </div>
