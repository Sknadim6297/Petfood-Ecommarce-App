...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="text-dark fw-bold mb-1">✏️ Edit Blog Post</h2>
    ...
    <div class="row">
        <!-- Main Content -->
        <div class="col-lg-8">
            <form action="{{ route('admin.content.blogs.update', $blog) }}" method="POST" enctype="multipart/form-data" id="blogForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" 
                                       ...
                                       placeholder="post-url-slug" required readonly>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Write a brief summary of your blog post..." required>{{ old('description', $blog->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="status" name="status" 
                                   value="1" {{ old('status', $blog->status) ? 'checked' : '' }} form="blogForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="featured" name="featured" 
                                   value="1" {{ old('featured', $blog->featured) ? 'checked' : '' }} form="blogForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="comments_enabled" name="comments_enabled" 
                                   value="1" {{ old('comments_enabled', $blog->comments_enabled) ? 'checked' : '' }} form="blogForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control @error('published_at') is-invalid @enderror" 
                               ...
                               value="{{ old('published_at', $blog->published_at ? $blog->published_at->format('Y-m-d\TH:i') : '') }}" form="blogForm">
                        @error('published_at')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-text">
