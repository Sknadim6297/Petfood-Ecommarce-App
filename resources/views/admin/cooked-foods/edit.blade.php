...
<div class="row">
    <div class="col-12">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="mb-0">Edit Cooked Food Item</h2>
                <p class="text-muted mb-0">Update details for: {{ $cookedFood->name }}</p>
            </div>
            <div class="d-flex gap-2">
                <a href="{{ route('admin.cooked-foods.show', $cookedFood) }}" class="btn btn-outline-info">
        ...
        <form action="{{ route('admin.cooked-foods.update', $cookedFood) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section">
                <div class="d-flex justify-content-end gap-3">
                    <a href="{{ route('admin.cooked-foods.show', $cookedFood) }}" class="btn btn-secondary">
